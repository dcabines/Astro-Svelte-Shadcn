  ...
  >
    ...
    <Menubar.Menu>
      ...
      <Menubar.Content
        ...
        sideOffset={3}
      >
        <Menubar.Item href="/" class="flex h-10 select-none items-center rounded-button py-3 pl-3 pr-1.5 text-sm font-medium !ring-0 !ring-transparent data-[highlighted]:bg-muted">
          Home
        </Menubar.Item>

        <Menubar.Item href="/joke-tax" class="flex h-10 select-none items-center rounded-button py-3 pl-3 pr-1.5 text-sm font-medium !ring-0 !ring-transparent data-[highlighted]:bg-muted">
          Joke Tax
        </Menubar.Item>
